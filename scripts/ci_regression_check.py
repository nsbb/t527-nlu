...
GOLDEN_SETS = [
    ('test_suite', 'data/golden/test_suite.json', 'TS 3043 (회귀 체크용)'),
    ('ruel_known', 'data/golden/gt_known_scenarios_v2.json', '르엘 공식 GT known 204'),
    ('ruel_unknown', 'data/golden/gt_unknown_scenarios.json', '르엘 공식 GT unknown 15'),
]
