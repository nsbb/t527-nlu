...
SINGLE_TESTS = [
    ...
    # ── v116: 습도/냄새/미세먼지 시나리오 ────────────────────────────────────
    ("비가 와서 그런지 굉장히 습하네",   "vent_control",   "on",  None,          "v116_비와서습하네_vent"),
    ("생선구이 하는데 냄새 심하겠다",    "vent_control",   "on",  None,          "v116_생선구이냄새_vent"),
    ("오늘 미세먼지 심한 날인데 창문 닫아야겠다", "door_control","close",None,   "v116_미세먼지_창문닫기"),

    # ── v117: STT확장/요리예고/소원형 ────────────────────────────────────────
    ("남바 하나 올려줘",               "heat_control",   "up",  None,          "v117_STT_남바_난방"),
    ...
    # ── v123: STT오인식(에어킁/보이라)/창문열려있네/불켜져있어/창문열어주겠어요/환기해주시겠어요 ──
    ("에어킁 켜줘",                  "ac_control",    "on",  None,           "v123_STT_에어킁_에어컨"),
    ("보이라 켜줘",                  "heat_control",  "on",  None,           "v123_STT_보이라_보일러"),
    ("창문이 활짝 열려있네",         "door_control",  "close",None,          "v123_창문활짝열려있네_close"),
    ...
    # ── v131: 황사창문닫/후텁지근/탁한것같/환기해야겠/날씨좋은데환기/월패드제어 ──
    ("황사 때문에 창문 꼭 닫아야 해","door_control",  "close",None,           "v131_황사창문닫_close"),
    ("이 방 왜 이렇게 후텁지근해",   "ac_control",    "on",  None,           "v131_후텁지근_on"),
    ("뭔가 탁한 것 같아",            "vent_control",  "on",  None,           "v131_탁한것같_on"),
    ("환기 좀 해야겠어",             "vent_control",  "on",  None,           "v131_환기해야겠어_on"),
    ("오늘 날씨 좋은데 환기 한 번 해볼까","vent_control","on",None,           "v131_날씨좋은데환기"),
    ("환기시키고 청소할게",          "vent_control",  "on",  None,           "v131_환기시키고청소"),
    ("월패드로 에어컨 제어 가능해?", "system_meta",   "none",None,           "v131_월패드제어가능"),
]
