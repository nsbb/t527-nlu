...
| 지표 | 값 | 비고 |
|------|-----|------|
| **Exact match** | **212/219 (96.8%)** | +77 vs 초기 (2026-04-26 기준) |
| **High sim (≥0.5)** | 1/219 (0.5%) | 주방 조명 모순 CSV |
| **Usable (exact + high)** | **213/219 (97.3%)** | **최종 천장 (true ceiling)** |
| Medium sim (≥0.3) | 0/219 (0.0%) | |
| Low sim (<0.3) | 6/219 (2.7%) | 진짜 unfixable |
