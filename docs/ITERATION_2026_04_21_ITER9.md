...
| 9 | 알람 rule dir 덮어쓰기 제거 (TS 불일치) | +0.10%p | 0 |
| **총** | **10개 규칙** | **+1.38%p** | **0** |
...
|------|:---:|:---:|:---:|
| TS combo (ensemble+rules) | 94.38% | **95.76%** | **+1.38%p** |
| KE fn | 97.20% | 97.20% | 0 |
| GT 219 | 95.0% | 95.0% | 0 |
| Latency (ms/query) | 0.85 | 0.67 | - (rule 오버헤드 없음) |

**sap_inference_v2 (v46+rules)**: TS 94.41% → 94.68% (+0.27%p)
