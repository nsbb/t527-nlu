...
| 지표 | v1 | v28 | v46 | 앙상블 | **+ iter9 rules (현재 배포)** |
|------|:---:|:---:|:---:|:---:|:---:|
| Test Suite combo | ~85% | 96.3% | 93.3% | 94.3% | **95.76%** |
| KoELECTRA fn | ~45% | 75.5% | 97.8% | 97.8% | 97.20% |
| 파일 | - | nlu_v28_final.onnx | nlu_v46.onnx | nlu_v28_v46_ensemble.onnx | 동일 + rules |
| 크기 | - | 100MB | 100MB | 105MB | 105MB |
| 추론 (CPU) | - | 0.37ms | 0.37ms | 0.48ms | **0.67ms** (rules 포함) |
