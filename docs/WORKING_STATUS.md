...
| v131 | 황사창문닫(gas교정), 후텁지근→ac/on(unknown교정), 탁한것같(light교정), 환기해야겠어→on |
| v130 | 소등→off, 개방→open, 가동/점화→on, 더위녹아내릴→ac/on, 답답해미치겠어→vent/on, 도치표현 |
| v129 | 은은하게→down, 환해졌으면→up, 환기됐으면→on, 등줄기서늘→heat/on, 히터잤더니더워→off, 외출잠가줘→security/on |
